                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-5 col-xl-4 ml-auto">
                                    ...
                                    <div class="card p-4 rounded-plus bg-faded">
                                        <form id="js-login" novalidate="" action="javascript:void(0)" method="POST">
                                            <input type="hidden" name="loginForm" value="1">
                                            <div class="form-group">
                                                <label class="form-label" for="username">Username</label>
                                                <input type="email" id="username" class="form-control form-control-lg" name="username" placeholder="your id or email" value="drlantern@gotbootstrap.com" required>
                                                <div class="invalid-feedback">No, you missed this one.</div>
                                                <div class="help-block">Your unique username to app</div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="password">Password</label>
                                                <input type="password" id="password" class="form-control form-control-lg" name="password" placeholder="password" value="password123" required>
