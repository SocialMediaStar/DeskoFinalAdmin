                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-users-class"></i>  <span class='fw-300'>Osakonnad</span>
                            </h1>
                        ...
                        <div class="row">
                            <div class = "col-xl-12 text-center">
                                <button class="btn btn-primary" data-toggle="modal" data-target="#modal-department-add"><i class="fal fa-plus"></i> Lisa osakond</button>
                            </div>
                            <div class="col-xl-6 offset-xl-3 mt-2">
                                <div class="input-group input-group-lg bg-white shadow-inset-2">
                                    <input type="text" name="search" class="form-control border-right-0 bg-transparent pr-0" placeholder="Otsi osakonna nime / juhi järgi">
                            ...
                            <div class="col-xl-12 mt-4" id="departmentList">
                            </div>
                        </div>
                    </main>
